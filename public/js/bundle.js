...
exports.hideAlert = exports.displayAlert = void 0;
var displayAlert = function displayAlert(type, msg, time) {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (result.data.status === 'success') {
            (0, _alerts.displayAlert)('success', 'Logged in successfully!');
        ...
        case 7:
          ...
          (0, _alerts.displayAlert)('error', _context.t0.response.data.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.displayAlert)('error', 'An error occurred logging out. Please try again. ');
        case 10:
        case "end":
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(first_name, last_name, email, password, passwordConfirm, role) {
    var result, field;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 27:
          if (!(typeof result.data.message.errors !== 'undefined')) {
            _context.next = 32;
            break;
          }
          field = Object.keys(result.data.message.errors);
        ...
        case 37:
          _context.prev = 37;
          _context.t0 = _context["catch"](0);
          if (typeof _context.t0.response !== 'undefined') {
            (0, _alerts.displayAlert)('error', _context.t0.response.data.message);
          } else {
            (0, _alerts.displayAlert)('error', _context.t0);
          }
        case 40:
        case "end":
          return _context.stop();
  ...
  return function register(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXJpa2pvaG5zb24wNiIsImEiOiJjbGlpbmc1YWswMDJxM2ZsZ2E0dnNzZjBtIn0.ZOkpKCHGncJxvx_vjzP-7w';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? '/api/v1/users/updatePassword' : '/api/v1/users/updateUserData';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          result = _context.sent;
          if (result.data.status === 'success') {
            (0, _alerts.displayAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));
          }
          _context.next = 11;
          break;
        case 8:
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NLNugLD9diXR5pVy6RQScVwINTtYdK6HUvs5SiK2diPloqQSkrTlhCr3EJpRJ2EFbdtZQniE1iJSpQz2ojcqWQJ00wZhT9fED'); //Get session from server
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
...
exports.saveReview = exports.launchReviewModal = exports.closeReviewModal = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var launchReviewModal = function launchReviewModal() {
  document.querySelector('.review-modal').style.display = 'block';
};
exports.launchReviewModal = launchReviewModal;
 ...
 * @returns {void}
 */
exports.closeReviewModal = closeReviewModal;
var saveReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, tour, slug) {
    var result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 10:
          ...
          (0, _alerts.displayAlert)('success', 'Thanks for sharing your review!');
          window.setTimeout(function () {
  ...
  return function saveReview(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var lauchAddReview = document.getElementById('launch-review-modal');
var saveReviewBtn = document.getElementById('save-review');
...
if (lauchAddReview) {
  lauchAddReview.addEventListener('click', function (e) {
    (0, _review.launchReviewModal)();
  });
}
if (saveReviewBtn) {
  saveReviewBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId;
    var slug = e.target.dataset.tourSlug;
    console.log(review, rating, tourId, slug);
    (0, _review.saveReview)(review, rating, tourId, slug);
  });
  if (closeReview) {
    closeReview.addEventListener('click', function (e) {
      (0, _review.closeReviewModal)();
    });
  }
}
if (loginForm) {
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _register.register)(firstName, lastName, email, password, passwordConfirm, roleVal);
  });
}
if (userDataForm) {
